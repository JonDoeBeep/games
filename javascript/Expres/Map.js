const map = {
  ...
  cities: [
    {x: 47, y:  4, name: "Boston"},
    {x: 46, y:  7, name: "New York"},
    {x: 45, y:  7, name: "Philadelphia"},
    {x: 42, y:  6, name: "Buffalo"},
    {x: 44, y: 10, name: "Washington"},
    {x: 43, y: 11, name: "Richmond"},
    {x: 37, y:  7, name: "Detroit"},
    {x: 37, y: 10, name: "Cincinnati"},
    {x: 36, y: 14, name: "Nashville"},
    {x: 39, y: 16, name: "Atlanta"},
    {x: 43, y: 15, name: "Charleston"},
    {x: 42, y: 19, name: "Jacksonville"},
    {x: 29, y:  3, name: "Duluth"},
    {x: 29, y:  5, name: "St. Paul"},
    {x: 33, y:  8, name: "Chicago"},
    {x: 32, y: 12, name: "St. Louis"},
    {x: 34, y: 15, name: "Memphis"},
    {x: 34, y: 21, name: "New Orleans"},
    {x: 25, y:  4, name: "Fargo"},
    {x: 26, y: 10, name: "Omaha"},
    {x: 28, y: 12, name: "Kansas City"},
    {x: 30, y: 16, name: "Little Rock"},
    {x: 28, y: 19, name: "Dallas"},
    {x: 24, y: 22, name: "San Antonio"},
    {x: 13, y: 10, name: "Salt Lake City"},
    {x: 19, y: 10, name: "Cheyenne"},
    {x: 19, y: 12, name: "Denver"},
    {x: 18, y: 16, name: "Santa Fe"},
    {x: 23, y: 19, name: "Sweetwater"},
    {x: 18, y: 20, name: "El Paso"}, 
    {x: 13, y:  5, name: "Helena"},
    {x:  5, y:  3, name: "Seattle"}, 
    {x:  5, y:  5, name: "Portland"},
    {x:  4, y: 12, name: "Sacramento"},
    {x:  3, y: 13, name: "San Francisco"},
    {x:  6, y: 17, name: "Los Angeles"}
  ]
}